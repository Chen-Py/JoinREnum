...
class Query{
    ...
    public:
        ...
        double AGM(vector<int> &cars){
            ...
            double ans0 = sqrt((double)cars[0] * cars[1] * cars[2]) * sqrt((double)cars[3] * cars[4] * cars[5]);
            ...
            return min(sqrt((double)cars[0] * cars[1]) * sqrt((double)cars[2] * cars[3]), (double)cars[1] * cars[2]);
            return (double)cars[0] * cars[1];
            if(true){
